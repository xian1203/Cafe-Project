      ...
      <Card className="w-full max-w-md rounded-2xl shadow-2xl border-0 animate-fade-in">
        <CardHeader>
          <div className="flex flex-col items-center mb-4">
            ...
            <img
              src="/assets/logo.png"
              alt="Logo"
              className="h-14 w-14 object-contain rounded-full shadow-md border-2 border-green-100 dark:border-green-900"
            />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-10 text-lg py-3 text-gray-900 dark:text-gray-100 rounded-xl border-2 border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 transition-colors duration-200"
                style={{ color: 'black' }}
              />
            </div>
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-10 pr-10 text-lg py-3 text-gray-900 dark:text-gray-100 rounded-xl border-2 border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 transition-colors duration-200"
                style={{ color: 'black' }}
              />
              <button
                type="button"
        ...
        <CardFooter className="text-center">
          <p className="text-sm">
            ...
            <Link to="/signup" className="font-medium text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 transition-colors duration-200">
              Sign up
            </Link>
          </p>
        </CardFooter>
